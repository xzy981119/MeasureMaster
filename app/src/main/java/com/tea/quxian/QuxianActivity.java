...
import database.QuxianDbSheme.QuxianLibBaseHelper;
import database.QuxianDbSheme.QuxianLibDbSheme;
...
public class QuxianActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mbutton = (Button) findViewById(R.id.xianlu_button);
        mbutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try{//
                    ...
                    zhuanjiao = Double.valueOf(Geopro.hudutoDMS(Double.valueOf(mzhuanjiao.getText().toString())));
                    ...
                    Toast.makeText(QuxianActivity.this, "请填写全部数据", Toast.LENGTH_SHORT).show();
                    return;
                }
                //endregion
                //region 曲线要素计算
                ...
                fangwei = Geopro.fangweijiaojisuan(qhz_X,qhz_Y,jd_X,jd_Y);
                ...
                for (int i = 0; i < zhuanghao.size(); i++)//遍历所有里程桩号
                {
                    ...
                    if (zhuanghao.get(i) > KZH && zhuanghao.get(i) <= KHY)
                    {
                        QA = 0;
                        QT = fangwei;
                        ZA = k * 1.0 / banjing;
                ...
                {
                    str1 += String.format("%-20.3f", zhuanghao.get(i)) + String.format("%-25.3f", Xzuobiao.get(i)) + String.format("%-20.3f", Yzuobiao.get(i)) + String.format("%-20f", Geopro.hudutoDMS(fangweijiao.get(i)));
                ...
                Intent intent = new Intent(QuxianActivity.this,Quxian_resultActivity.class);
    ...
    private void  Database(int i){
        ...
        mDatabase=new QuxianLibBaseHelper(QuxianActivity.this).getWritableDatabase();
        ContentValues values=new ContentValues();
        values.put(QuxianLibDbSheme.QuxianLibTable.Cols.UUID,uuid.toString());
        values.put(QuxianLibDbSheme.QuxianLibTable.Cols.ZHUANGHAO, zhuanghao.get(i).toString());
        values.put(QuxianLibDbSheme.QuxianLibTable.Cols.X,mGeopro.div1(Double.valueOf(Xzuobiao.get(i).toString())));
        values.put(QuxianLibDbSheme.QuxianLibTable.Cols.Y,mGeopro.div2(Double.valueOf(Yzuobiao.get(i).toString())));
        values.put(QuxianLibDbSheme.QuxianLibTable.Cols.FANGWEIJIAO,Geopro.hudutoDMS(fangweijiao.get(i)));
        values.put(QuxianLibDbSheme.QuxianLibTable.Cols.LEFTX,mGeopro.div2(Double.valueOf(leftX.get(i).toString())));
        values.put(QuxianLibDbSheme.QuxianLibTable.Cols.LEFTY,mGeopro.div2(Double.valueOf(leftY.get(i).toString())));
        values.put(QuxianLibDbSheme.QuxianLibTable.Cols.RIGHTX,mGeopro.div2(Double.valueOf(rightX.get(i).toString())));
        values.put(QuxianLibDbSheme.QuxianLibTable.Cols.RIGHTY,mGeopro.div2(Double.valueOf(rightY.get(i).toString())));
        mDatabase.insert(QuxianLibDbSheme.QuxianLibTable.NAME,null,values);
    }
}
