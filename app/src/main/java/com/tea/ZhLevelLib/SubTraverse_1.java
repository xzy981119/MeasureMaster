...
public class SubTraverse_1 extends AppCompatActivity {
    //region 定义控件变量
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_zhlevellib_wang);
        getWindow().setSoftInputMode( WindowManager.LayoutParams.SOFT_INPUT_STATE_HIDDEN);//不让自动弹出软键盘

        //region 找到控件
        hou_black_shang = (EditText)findViewById(R.id.shuizhun_hou_black_shang_1);
        hou_black_zhong = (EditText)findViewById(R.id.shuizhun_hou_black_zhong_1);
        hou_black_xia = (EditText)findViewById(R.id.shuizhun_hou_black_xia_1);
        hou_red_zhong = (EditText)findViewById(R.id.shuizhun_hou_red_zhong_1);
        qian_black_shang = (EditText)findViewById(R.id.shuizhun_qian_black_shang_1);
        qian_black_xia = (EditText)findViewById(R.id.shuizhun_qian_black_xia_1);
        qian_black_zhong = (EditText)findViewById(R.id.shuizhun_qian_black_zhong_1);
        qian_red_zhong = (EditText)findViewById(R.id.shuizhun_qian_red_zhong_1);
        editText_station = (EditText)findViewById(R.id.shuizhun_station_1);
        editText_K_hou = (EditText)findViewById(R.id.shuizhun_K_hou_1);
        editText_K_qian = (EditText)findViewById(R.id.shuizhun_K_qian_1);
        lastStation = (TextView)findViewById(R.id.shuizhun_lastStation_1);
        leijicha_text = (TextView)findViewById(R.id.shuizhun_leijicha_1);
        //endregion

        //region 标题栏
        toolbar = (Toolbar)findViewById(R.id.toolbar_shuizhun_1);
        ...
        button = (Button) findViewById(R.id.shuizhun_jisuan_1);
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try{
                    ...
                    Toast.makeText(SubTraverse_1.this, "请正确填写全部数据", Toast.LENGTH_SHORT).show();
                    return;
                }
                //endregion
                //region 测站检核计算
                ...
                //region 数据存储
                ZhLevelLib_result.juli.add(Geopro.Round(houshiju + qianshiju,1));
                ZhLevelLib_result.gaocha.add(gaocha_avg);
                ZhLevelLib_result.cezhan.add(cezhan);
                //endregion
                Intent intent = new Intent(SubTraverse_1.this,LevelLib_station_1.class);
