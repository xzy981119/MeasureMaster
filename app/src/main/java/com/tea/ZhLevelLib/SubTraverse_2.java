...
public class SubTraverse_2 extends AppCompatActivity {
    //region 定义控件变量
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_zhlevellib_fan);
        getWindow().setSoftInputMode( WindowManager.LayoutParams.SOFT_INPUT_STATE_HIDDEN);//不让自动弹出软键盘

        //region 找到控件
        hou_black_shang = (EditText)findViewById(R.id.shuizhun_hou_black_shang_2);
        hou_black_zhong = (EditText)findViewById(R.id.shuizhun_hou_black_zhong_2);
        hou_black_xia = (EditText)findViewById(R.id.shuizhun_hou_black_xia_2);
        hou_red_zhong = (EditText)findViewById(R.id.shuizhun_hou_red_zhong_2);
        qian_black_shang = (EditText)findViewById(R.id.shuizhun_qian_black_shang_2);
        qian_black_xia = (EditText)findViewById(R.id.shuizhun_qian_black_xia_2);
        qian_black_zhong = (EditText)findViewById(R.id.shuizhun_qian_black_zhong_2);
        qian_red_zhong = (EditText)findViewById(R.id.shuizhun_qian_red_zhong_2);
        editText_station = (EditText)findViewById(R.id.shuizhun_station_2);
        editText_K_hou = (EditText)findViewById(R.id.shuizhun_K_hou_2);
        editText_K_qian = (EditText)findViewById(R.id.shuizhun_K_qian_2);
        lastStation = (TextView)findViewById(R.id.shuizhun_lastStation_2);
        leijicha_text = (TextView)findViewById(R.id.shuizhun_leijicha_2);
        //endregion

        //region 标题栏
        toolbar = (Toolbar)findViewById(R.id.toolbar_shuizhun_2);
        ...
        button = (Button) findViewById(R.id.shuizhun_jisuan_2);
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try{
                    ...
                    Toast.makeText(SubTraverse_2.this, "请正确填写全部数据", Toast.LENGTH_SHORT).show();
                    return;
                }
                //endregion
                //region 测站检核计算
                ...
                //region 数据存储
                ZhLevelLib_result.juli_1.add(Geopro.Round(houshiju + qianshiju,1));
                ZhLevelLib_result.gaocha_1.add(gaocha_avg);
                ZhLevelLib_result.cezhan1.add(cezhan);
                //endregion
                Intent intent = new Intent(SubTraverse_2.this,LevelLib_station.class);
