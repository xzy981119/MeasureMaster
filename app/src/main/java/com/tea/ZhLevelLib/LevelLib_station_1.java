...
public class LevelLib_station_1 extends AppCompatActivity {
    //region 定义变量
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button_next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                //将该条记录到数据库
                //endregion
                Toast.makeText(LevelLib_station_1.this, "数据已添加数据库", Toast.LENGTH_SHORT).show();
                isnext = true;
                finish();
            }
        });
        ...
        button_pingcha.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent1 = new Intent(LevelLib_station_1.this, SubTraverse_2.class);
